...
module Oled_Show_Info(
	...
	output[23:0]	 show_data		//清除数据的命�?
);

localparam			RST_T 			=	1'b0;				//复位有效
localparam			STR_WIDTH      =6'd16;//字符宽大�?
...
assign show_ack = (show_index >= SHOW_INDEX_SET && show_page >= SHOW_PAGE_SET && write_done == 1'b1) ? 1'b1 : 1'b0;//完成�?个中文字符写�?
...
begin
	...
	default:show_data_reg <= {8'h78,8'h40, data};
	endcase
end
...
font_data font_data_HP(
	...
	.page_cur (show_page),	//当前�?
	.index_cur (show_index),	//当前�?
